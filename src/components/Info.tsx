    ...
    return (
        <section id="intro" className="ttb" style={{minHeight: '80vh', flexWrap: 'nowrap', paddingTop: '20px', marginTop: 0 }}>
            ...
            <div className="br tip">
                During the <AnchorLink offset={window.innerHeight * 0.12} href="#lap1"><em className="xbold">Discovery</em></AnchorLink> and <AnchorLink offset={window.innerHeight * 0.12} href="#delivery"><em className="xbold">Delivery</em></AnchorLink> sections of the <em className="xbold">12-week intensive training</em>, trainees work with their trainers to identify areas of particular strength. Trainers use these insights to create discipline ‘pods’. Each pod works separately on selected modules to enhance their insight into 
            ...
            <div className='tip'>
                Throughout the <AnchorLink offset={window.innerHeight * 0.12} href='#placement'><em className="xbold">2-year placement</em></AnchorLink> , trainees have access to our full catalogue of <em className="xbold">additional content</em> across a range of topics including <em className="xbold">more languages & tools</em> as well as <em className="xbold">advanced concepts</em> not covered on the 12-week intensive training.
            </div>
        </section>
    )
}